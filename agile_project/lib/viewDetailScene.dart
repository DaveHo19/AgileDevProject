...
class viewDetailScene extends StatefulWidget {
  final BookManagement bookManagement;
  final Book book;

  const viewDetailScene(
      {Key? key, required this.bookManagement, required this.book})
      : super(key: key);

  @override
  State<viewDetailScene> createState() => _viewDetailSceneState();
}

class _viewDetailSceneState extends State<viewDetailScene> {
    ...
    return Center(
      child: Container(
        ...
        child: GestureDetector(
          ...
          child: (imgSrc == null)
              ? Image.network(widget.book.imageCoverURL, fit: BoxFit.fill)
